...
if __name__ == '__main__':
    ...
    # best_embed_cluster_threshold: 0.37 best_embed_ave_f1: 0.8300666666666667
    # only use KG embedding ...
    # Ave-prec= 0.8769666666666667 macro_prec= 0.8212 micro_prec= 0.8952 pair_prec= 0.9145
    # Ave-recall= 0.7946666666666667 macro_recall= 0.5997 micro_recall= 0.8814 pair_recall= 0.9029
    # Ave-F1= 0.8300666666666667 macro_f1= 0.6932 micro_f1= 0.8883 pair_f1= 0.9087
    # Model: #Clusters: 6773, #Singletons 1839
    # Gold: #Clusters: 6068, #Singletons 314

    # best_embed_cluster_threshold: 0.38 best_embed_ave_f1: 0.8304
    # only use KG embedding ...
    # Ave-prec= 0.871 macro_prec= 0.813 micro_prec= 0.89 pair_prec= 0.91
    # Ave-recall= 0.7996666666666666 macro_recall= 0.6088 micro_recall= 0.8853 pair_recall= 0.9049
    # Ave-F1= 0.8304 macro_f1= 0.6962 micro_f1= 0.8876 pair_f1= 0.9074
    # Model: #Clusters: 6647, #Singletons 1756
    # Gold: #Clusters: 6068, #Singletons 314

    # '--use_cross_seed', default=False '--combine_seed_and_train_data', default=True 50000
    # best_embed_cluster_threshold: 0.34 best_embed_ave_f1: 0.8231999999999999
    # only use KG embedding ...
    # Ave-prec= 0.8758333333333334 macro_prec= 0.8319 micro_prec= 0.8962 pair_prec= 0.8994
    # Ave-recall= 0.7859333333333334 macro_recall= 0.5778 micro_recall= 0.8753 pair_recall= 0.9047
    # Ave-F1= 0.8231999999999999 macro_f1= 0.6819 micro_f1= 0.8856 pair_f1= 0.9021
    # Model: #Clusters: 6978, #Singletons 2049
    # Gold: #Clusters: 6068, #Singletons 314

    # '--use_cross_seed', default=False '--combine_seed_and_train_data', default=True 100000
    # best_embed_cluster_threshold: 0.37 best_embed_ave_f1: 0.8302999999999999
    # only use KG embedding ...
    # Ave-prec= 0.8737333333333334 macro_prec= 0.8191 micro_prec= 0.8925 pair_prec= 0.9096
    # Ave-recall= 0.7977 macro_recall= 0.6037 micro_recall= 0.8831 pair_recall= 0.9063
    # Ave-F1= 0.8302999999999999 macro_f1= 0.6951 micro_f1= 0.8878 pair_f1= 0.908
    # Model: #Clusters: 6729, #Singletons 1805
    # Gold: #Clusters: 6068, #Singletons 314
