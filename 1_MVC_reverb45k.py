...
if __name__ == '__main__':
    ...
    parser.add_argument('--view_version', default=1.2)  # bert_max_len = 256, ave_len=63, epoch=100 context view seed is EL + Web
    # parser.add_argument('--view_version', default=1.25)  # bert_max_len = 256, ave_len=63, epoch=100 context view seed is EL

    # n_cluster: <class 'int'> 6700
    # multi-view spherical-k-means final result :
    # Ave-prec= 0.8684666666666666 macro_prec= 0.8059 micro_prec= 0.8984 pair_prec= 0.9011
    # Ave-recall= 0.7853666666666667 macro_recall= 0.5829 micro_recall= 0.8721 pair_recall= 0.9011
    # Ave-F1= 0.8209 macro_f1= 0.6765 micro_f1= 0.8851 pair_f1= 0.9011
    # Model: #Clusters: 6699, #Singletons 1627
    # Gold: #Clusters: 6068, #Singletons 314
    # clustering time:  144.21853970289231 minute
    # time: 2021_07_07 21:19:51
    ...
    # 50000 2000 2000 0.8201
    # 50000 2000 4000 0.8272
    # 50000 2000 6000 0.8265
    # 50000 1000 2000 0.8274
    # 50000 1000 4000 0.8247
    # 100000 2000 1000 0.8158
    # 40000  2000 2000 0.8202
    # 40000  2000 4000 0.8249
    # 40000  2000 6000 0.8255
    # 40000  1000 2000 0.8228
